...
public class login_signUp extends JFrame {
    ...
    JLabel ScoreDBMS2 = new JLabel("80");
    JLabel ScoreEng2 = new JLabel("90");
    JLabel ScoreNetwork2 = new JLabel("95");
    JLabel ScoreAlgo2 = new JLabel("70");
    JLabel ScoreJava2 = new JLabel("100");
...
//        String name = "Visal 11";
        ...
        add(Subject);
        Java1.setBounds(20 , 200 , 70 , 20);
        add(Java1);
        DBMS1.setBounds(20 , 220 , 70 , 20);
        add(DBMS1);
        Network1.setBounds(20 , 240 , 70 ,20);
        add(Network1);
        Algo1.setBounds(20 , 260 , 70 , 20);
        add(Algo1);
        Eng1.setBounds(20,280 , 70 ,20);
        add(Eng1);
        Score.setBounds(180 , 180 , 40 , 20);
        add(Score);
        ScoreJava1.setBounds(180 , 200 , 40 , 20);
        add(ScoreJava1);
        ScoreDBMS1.setBounds(180 , 220 , 40 , 20 );
        add(ScoreDBMS1);
        ScoreNetwork1.setBounds(180 , 240 , 4 ,20);
        add(ScoreNetwork1);
